...
class _MenuPageState extends State<MenuPage> {
  final List<PizzaItem> menuItems = [
    PizzaItem(name: 'Margherita', price: 'R\$ 30,00', imagePath: 'assets/margherita.png'),
    PizzaItem(name: 'Pepperoni', price: 'R\$ 35,00', imagePath: 'assets/pepperoni.png'),
    PizzaItem(name: 'Quatro Queijos', price: 'R\$ 40,00', imagePath: 'assets/quatro_queijos.png'),
  ];
